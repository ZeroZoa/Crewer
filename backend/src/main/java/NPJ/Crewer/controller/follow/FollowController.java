package NPJ.Crewer.controller.follow;

import NPJ.Crewer.service.follow.FollowService;
...
public class FollowController {
    ...
    public ResponseEntity<FollowListResponse> getMyFollowers(
        ...
        FollowListResponse response = followService.getFollowers(currentMemberId, currentMemberId, pageable);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<FollowListResponse> getMyFollowing(
        ...
        FollowListResponse response = followService.getFollowing(currentMemberId, currentMemberId, pageable);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<FollowListResponse> getFollowers(
            ...
            @AuthenticationPrincipal(expression = "id") Long currentMemberId,
            @PageableDefault(size = 30) Pageable pageable) {
        FollowListResponse response = followService.getFollowersByUsername(username, currentMemberId, pageable);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<FollowListResponse> getFollowing(
            ...
            @AuthenticationPrincipal(expression = "id") Long currentMemberId,
            @PageableDefault(size = 30) Pageable pageable) {
        FollowListResponse response = followService.getFollowingByUsername(username, currentMemberId, pageable);
        return ResponseEntity.ok(response);
    }
} 